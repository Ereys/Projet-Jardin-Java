...
public class ParcelleJ implements Parcelle{
     ...
     */
    @SuppressWarnings("unchecked")
    public Iterator<ActionParcelle> getAllActions(){
        ParcelleJ walkingUp = this;
        ArrayList<ActionParcelle> allActions = (ArrayList<ActionParcelle>) actions.clone();
        while (walkingUp.pointPoint != walkingUp) {
            walkingUp = walkingUp.pointPoint; // moveUp
            ArrayList<ActionParcelle> copiesActions = (ArrayList<ActionParcelle>) walkingUp.actions.clone();
     ...
     */
    public void addActionParcelle(ActionParcelle a){
        actions.add(a);
    }
