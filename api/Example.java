...
public class Example{
    ...
    public static void main(String[] args) {
        ...
        // Il faut une factocry pour faire des légumes
        ...
        p00.addActionParcelle(a4);
        p001.addActionParcelle(a5);
        p001.addActionParcelle(a6);
        p001.addActionParcelle(a7);
        p001.addActionParcelle(a8);
